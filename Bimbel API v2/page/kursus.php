...
<body class="back">
    ...
    <!-- navbar end -->
    <!-- kursus Section start -->
    <section id="kursus" class="kursus">
        <div class="container">
            <h1 class="fw-bold text-center mx-auto">Kursus Kami</h1>
            <div class="row text-center">
                <!-- card 1 -->
                <div class="col-xl-4 col-md-5 col-sm-6 mt-5">
                    <div class="card-kursus text-center">
                        <img src="/img/kursus/jari-aljabar.png" alt="aljabar" class="img-kursus mb-3" />
                        <div class="body-card text-center">
                            <h3>Jari Aljabar</h3>
                            <p>
                                Pelatihan hitung cepat Jari Aljabar ini akan terasa lebih
                                manfaatnya jika pesertanya adalah guru/orang tua murid
                                guru/orang tua yang akan mengajarkan kembali kepada
                                murid/anak-anaknya
                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus1">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                        </div>
                    </div>
                </div>
                ...
                <!-- card 2 -->
                <div class="col-xl-4 col-md-5 col-sm-6 mt-5">
                    <div class="top d-flex align-content-center">
                        <div class="card-kursus text-center">
                            ...
                            <div class="body-card text-center">
                                ...
                                <p>
                                    ...
                                    pelajaran yang sangat penting. Pelajaran berhitung ini
                                    bahkan menjadi ilmu yang mesti kita ajarkan kepada anak-anak
                                    sejak jaman kuno.
                                    <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus2">lanjut
                                        baca</a>
                                </p>
                                <!-- Button trigger modal -->
                                <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                    ...
                    <div class="card-kursus text-center">
                        ...
                        <div class="body-card text-center">
                            ...
                            <p>
                                ...
                                pelajaran atau bidang studi menjadi satu tema atau topik
                                pembahasan tertentu.
                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus3">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                ...
                <div class="col-xl-4 col-md-5 col-sm-6 mt-5">
                    <div class="card-kursus text-center">
                        ...
                        <div class="body-card text-center">
                            ...
                            <p>
                                Dengan mrnguasai bahasa asing kita tidak tertipu oleh warga
                                negar lain yang ingin menipu kita, dan yang paling utama
                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus4">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                    ...
                    <div class="card-kursus text-center">
                        ...
                        <div class="body-card text-center">
                            ...
                            <p>
                                ...
                                penting diajarkan semenjak dini. Membaca serta menulis sangat
                                .
                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus5">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                ...
                <div class="col-xl-4 col-md-5 col-sm-6 mt-5">
                    <div class="card-kursus">
                        ...
                        <div class="body-card text-center">
                            <h3>Komputer</h3>
                            <p>
                                Sulit rasanya membayangkan kehidupan masa kini tanpa komputer.
                                Tak heran kalau orang tua merasa perlu memperkenalkan anak
                                pada komputer
                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus8">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                    ...
                    <div class="card-kursus">
                        ...
                        <div class="body-card text-center">
                            ...
                            <p>
                                ...
                                dibutuhkan waktu yang sangat lama. Anak-anak harus mengikuti

                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus6">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                ...
                <div class="col-xl-4 col-md-5 col-sm-6 mt-5">
                    <div class="card-kursus">
                        ...
                        <div class="body-card text-center">
                            <h3>Melukis</h3>
                            <p>
                                Kegiatan melukis bukan sekedar hal yang menyenangkan bagi
                                anak. Melukis mempunyai berbagai manfaat
                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus7">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
                ...
                <div class="col-xl-4 col-md-5 col-sm-6 mt-5">
                    <div class="card-kursus">
                        ...
                        <div class="body-card text-center">
                            ...
                            <p>
                                menulis huruf tegak bersambung sering dianggap tidak relevan.
                                Bahkan, sebagian orang tua kerap mengeluh

                                <a href="" class="btn-card" data-bs-toggle="modal" data-bs-target="#kursus9">lanjut
                                    baca</a>
                            </p>
                            <!-- Button trigger modal -->
                            <a href="daftar.html" class="btn-kursus"><button type="button">Ikut les</button></a>
    ...
    <!-- modal -->
    <!-- Modal -->
    <div class="modal fade" id="kursus1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- kursus 2 -->
    <div class="modal fade" id="kursus2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Jari Aljabar</h5>
    ...
    <!-- kursus 3 -->
    <div class="modal fade" id="kursus3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- kursus 4 -->
    <div class="modal fade" id="kursus4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- kursus 5 -->
    <div class="modal fade" id="kursus5" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- kursus 6 -->
    <div class="modal fade" id="kursus6" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- kursus 7 -->
    <div class="modal fade" id="kursus7" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- kursus 8 -->
    <div class="modal fade" id="kursus8" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Komputer</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body modalkursus text-center">
                    <div class="img-modal p-2">
    ...
    <!-- kursus 8 -->
    <div class="modal fade" id="kursus9" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
